            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <?php
                        // Get the uid from the button in previous page
                        $userid = $_GET['uid'];
                        ...
                        while ($result = mysqli_fetch_array($query)) { ?>
                            ...
                            <div class="card mb-4">
                                <!-- jj -->
                                <div class="card-body">
                                    <a href="edit-employee-profile.php?uid=<?php echo $result['id']; ?>">Edit</a>
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            <th>Username</th>
                                            <td colspan="3"><?php echo $result['username']; ?></td>
                                        </tr>
                                        <tr>
                                            <th>Name Code</th>
                                            <td colspan="3"><?php echo $result['namecode']; ?></td>
                                        </tr>
                                        <tr>
                                            <th>Contact No.</th>
                                        ...
                                        <tr>
                                            <th>Role</th>
                                            <td colspan="3"><?php echo $result['empRole']; ?></td>
                                        </tr>
                                        <tr>
                                            <th>Reg. Date</th>
