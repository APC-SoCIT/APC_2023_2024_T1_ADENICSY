...
?>
    ...
    <body class="sb-nav-fixed">
        <?php include_once('employee-nav-staff.php'); ?>
        <main>
            <div class="container-fluid px-4">
                ...
                while ($result = mysqli_fetch_array($query)) { ?>
                    <div class="pt-5 m-3">
                        ...
                        <h1 class="mt-4 text-primary"><?php echo $result['fname']; ?>'s Profile</h1>
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <a class="btn btn-md btn-primary mb-2 float-end" href="staff-edit-profile.php">Update Profile</a>
                            </div>
                        </div>
                    </div>
                <?php } ?>
