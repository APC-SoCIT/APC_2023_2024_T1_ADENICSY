...
?>
    ...
    ?>
    <!-- Add this HTML code above the table -->
    <div class="mb-3" style="padding-top: 120px;">
        <label for="sort-select" class="form-label">Sort by:</label>
        <select class="form-select" id="sort-select">
            <option value="id">ID</option>
            <option value="item_name">Item Name</option>
            <option value="quantity">Quantity</option>
            <option value="last_modified_date">Last Modified Time</option>
        </select>
    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div id="table-wrapper">
                    ...
                    echo '<table id="inventory-table" class="table table-primary table-striped">';
                    echo '<thead class="text-primary h4">';
                    echo '<tr>';
                    echo '<th data-sort="id">ID</th>';
                    echo '<th data-sort="item_name">Item Name</th>';
                    echo '<th data-sort="quantity">Quantity</th>';
                    echo '<th data-sort="metric">Metric</th>';
                    echo '<th data-sort="critical_level">Critical Level</th>';
                    echo '<th data-sort="last_modified">Last Modified By</th>';
                    echo '<th data-sort="last_modified_date">Last Modified Time</th>';
                    echo '<th>Update</th>';
            ...
            <!-- Modify your JavaScript code to handle sorting -->
            <script>
                $(document).ready(function() {
                    $('#sort-select').change(function() {
                        const sortCriteria = $(this).val();
                        // Get the table rows and convert them to an array
                        const rows = Array.from($('#inventory-table tbody tr'));
                        // Sort the rows based on the selected criteria
                        rows.sort(function(a, b) {
                            const valueA = $(a).find(`td[data-sort="${sortCriteria}"]`).text();
                            const valueB = $(b).find(`td[data-sort="${sortCriteria}"]`).text();
