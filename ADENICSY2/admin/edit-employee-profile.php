...
if (strlen($_SESSION['adminid'] == 0)) {
    ...
    if (isset($_POST['update'])) {
        ...
        $userid = $_GET['uid'];
        $msg = mysqli_query($con, "update employee set fname='$fname',lname='$lname',empRole='$empRole',namecode='$code',contactno='$contact' where id='$userid'");
                                ...
                                <form method="post">
                                    <div class="card-body">
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                <th>Name Code</th>
                                                <td colspan="3"><input class="form-control" id="namecode" name="namecode" type="text" value="<?php echo $result['namecode']; ?>" required /></td>
                                            </tr>
                                            <tr>
                                                <th>Email</th>
                                            ...
                                            <tr>
                                                <th>Role</th>
                                                <td><input class="form-control" id="empRole" name="empRole" type="text" value="<?php echo $result['empRole']; ?>" required /></td>
                                            </tr>
                                            <tr>
                                                <th>Reg. Date</th>
